...
3) Create an appropriate random price to display for each pizza (say 15 to 35). No HTML elemenet needed
4) Enter quantity is a text input. No need to give id
...
function init() {
    // Challenge 2: Create HTML output as per the wireframe diagram image.
    let output = document.getElementById("output");
    for(let i = 1; i <= 5; i++) {
         let price = Math.floor(Math.random() * 35) + 15;
         output.innerHTML += `
            <div class="card">
